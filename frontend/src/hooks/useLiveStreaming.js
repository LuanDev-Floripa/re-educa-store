...
/**
 * useLiveStreaming
 * - Live streams com WebSocket, ações e fallbacks seguros
 */
...
export const useLiveStreaming = () => {
  ...
  useEffect(() => {
    const connectWebSocket = () => {
      try {
        ...
        console.error("Erro ao conectar WS:", err);
      }
    };
  ...
  const endStream = async (streamId) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/social/streams/${streamId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const joinStream = async (streamId) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/social/streams/${streamId}/join`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const leaveStream = async (streamId) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/social/streams/${streamId}/leave`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const sendMessage = async (messageData) => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/social/streams/${messageData.streamId}/messages`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const sendGift = async (giftData) => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/social/streams/${giftData.streamId}/gifts`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const reportStream = async (streamId, reason) => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/social/streams/${streamId}/report`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
