...
export const UserOnboarding = ({ 
  ...
  const goalOptions = [
    { id: 'weight_loss', label: 'Perda de Peso', icon: TrendingDown, color: 'text-green-600' },
    { id: 'muscle_gain', label: 'Ganho de Massa', icon: TrendingUp, color: 'text-blue-600' },
    { id: 'strength', label: 'Aumentar Força', icon: Target, color: 'text-red-600' },
    { id: 'endurance', label: 'Melhorar Resistência', icon: Activity, color: 'text-purple-600' },
    { id: 'flexibility', label: 'Flexibilidade', icon: Wind, color: 'text-yellow-600' },
    { id: 'health', label: 'Saúde Geral', icon: Heart, color: 'text-pink-600' },
    { id: 'sports', label: 'Performance Esportiva', icon: Trophy, color: 'text-orange-600' },
    { id: 'rehabilitation', label: 'Reabilitação', icon: Shield, color: 'text-gray-600' }
  ];

  const experienceLevels = [
    { id: 'beginner', label: 'Iniciante', description: 'Pouco ou nenhum experiência', icon: Star, color: 'text-green-600' },
    { id: 'intermediate', label: 'Intermediário', description: 'Alguma experiência', icon: Award, color: 'text-blue-600' },
    { id: 'advanced', label: 'Avançado', description: 'Muita experiência', icon: Crown, color: 'text-purple-600' },
    { id: 'expert', label: 'Especialista', description: 'Experiência profissional', icon: Diamond, color: 'text-yellow-600' }
  ];

  const activityLevels = [
    { id: 'sedentary', label: 'Sedentário', description: 'Pouco ou nenhum exercício', icon: Monitor, color: 'text-gray-600' },
    { id: 'light', label: 'Leve', description: 'Exercício leve 1-3x/semana', icon: Bike, color: 'text-green-600' },
    { id: 'moderate', label: 'Moderado', description: 'Exercício moderado 3-5x/semana', icon: Activity, color: 'text-blue-600' },
    { id: 'active', label: 'Ativo', description: 'Exercício intenso 6-7x/semana', icon: Flame, color: 'text-orange-600' },
    { id: 'very_active', label: 'Muito Ativo', description: 'Exercício muito intenso', icon: Zap, color: 'text-red-600' }
  ];

  const interestOptions = [
    { id: 'weightlifting', label: 'Musculação', icon: Dumbbell, color: 'text-blue-600' },
    { id: 'cardio', label: 'Cardio', icon: Heart, color: 'text-red-600' },
    { id: 'yoga', label: 'Yoga', icon: Wind, color: 'text-green-600' },
    { id: 'pilates', label: 'Pilates', icon: Activity, color: 'text-purple-600' },
    ...
    { id: 'martial_arts', label: 'Artes Marciais', icon: Shield, color: 'text-gray-600' },
    { id: 'dance', label: 'Dança', icon: Music, color: 'text-pink-600' },
    { id: 'outdoor', label: 'Atividades ao Ar Livre', icon: Mountain, color: 'text-green-600' },
    { id: 'team_sports', label: 'Esportes Coletivos', icon: Users, color: 'text-blue-600' },
    { id: 'nutrition', label: 'Nutrição', icon: Apple, color: 'text-green-600' }
  ];

  const categoryOptions = [
    { id: 'supplements', label: 'Suplementos', icon: Package, color: 'text-green-600' },
    { id: 'equipment', label: 'Equipamentos', icon: Dumbbell, color: 'text-blue-600' },
    { id: 'clothing', label: 'Roupas', icon: Shirt, color: 'text-purple-600' },
    { id: 'accessories', label: 'Acessórios', icon: Watch, color: 'text-orange-600' },
    { id: 'books', label: 'Livros', icon: Book, color: 'text-yellow-600' },
    { id: 'courses', label: 'Cursos', icon: GraduationCap, color: 'text-red-600' }
  ];

  const brandOptions = [
    'MuscleTech', 'Optimum Nutrition', 'Dymatize', 'BSN', 'Cellucor', 
    'Universal Nutrition', 'GNC', 'Centrum', 'Nike', 'Adidas', 'Under Armour'
  ];
  ...
  const validateStep = (stepId) => {
    ...
    switch (stepId) {
      case 'personal':
        ...
        break;
      case 'goals':
        if (formData.goals.length === 0) newErrors.goals = 'Selecione pelo menos um objetivo';
        break;
      case 'experience':
        if (!formData.experience) newErrors.experience = 'Nível de experiência é obrigatório';
    ...
    <div className="text-center space-y-6">
      ...
      <div>
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
          Vamos personalizar sua experiência para você alcançar seus objetivos de saúde e fitness
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
          ...
          <h3 className="font-semibold text-green-800 dark:text-green-200">Objetivos Personalizados</h3>
        ...
        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
          ...
          <h3 className="font-semibold text-blue-800 dark:text-blue-200">Planos de Treino</h3>
        ...
        <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
          ...
          <h3 className="font-semibold text-purple-800 dark:text-purple-200">Ferramentas de Saúde</h3>
  ...
  const renderGoalsStep = () => (
    <div className="space-y-6">
      <div>
        ...
        {errors.goals && <p className="text-red-500 text-sm mb-4">{errors.goals}</p>}
      </div>
  ...
  const renderExperienceStep = () => (
    <div className="space-y-6">
      <div>
        ...
        {errors.experience && <p className="text-red-500 text-sm mb-4">{errors.experience}</p>}
      </div>
      ...
      <div>
        ...
        {errors.activityLevel && <p className="text-red-500 text-sm mb-4">{errors.activityLevel}</p>}
      </div>
  ...
  const renderInterestsStep = () => (
    <div className="space-y-6">
      <div>
        ...
        {errors.interests && <p className="text-red-500 text-sm mb-4">{errors.interests}</p>}
      </div>
        ...
        {interestOptions.map((interest) => {
          ...
          return (
            <div
              ...
              onClick={() => handleArrayChange('interests', interest.id, !isSelected)}
            >
              <div className="text-center">
                <IconComponent className={`w-8 h-8 ${interest.color} mx-auto mb-2`} />
                <h3 className="font-semibold text-sm">{interest.label}</h3>
                {isSelected && <Check className="w-4 h-4 text-blue-600 mx-auto mt-2" />}
              </div>
            </div>
          );
        })}
        ...
        {categoryOptions.map((category) => {
          ...
          return (
            <div
              ...
              onClick={() => handleArrayChange('favoriteCategories', category.id, !isSelected)}
            >
              <div className="text-center">
  ...
  const renderCompleteStep = () => (
    <div className="text-center space-y-6">
      ...
      <div>
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
          Sua conta foi configurada com sucesso. Agora você pode começar sua jornada de saúde e fitness!
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
          ...
          <h3 className="font-semibold text-blue-800 dark:text-blue-200">Objetivos Definidos</h3>
          <p className="text-sm text-blue-700 dark:text-blue-300">
        ...
        <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
          ...
          <h3 className="font-semibold text-green-800 dark:text-green-200">Perfil Completo</h3>
          <p className="text-sm text-green-700 dark:text-green-300">
        ...
        <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
          ...
          <h3 className="font-semibold text-purple-800 dark:text-purple-200">Interesses</h3>
          <p className="text-sm text-purple-700 dark:text-purple-300">
        ...
        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
          ...
          <h3 className="font-semibold text-blue-800 dark:text-blue-200">Marcas Favoritas</h3>
          <p className="text-sm text-blue-700 dark:text-blue-300">
