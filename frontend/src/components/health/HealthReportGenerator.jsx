...
export const HealthReportGenerator = () => {
  ...
  const generateReport = async () => {
    ...
    setGenerating(true);
    try {
      const data = await apiClient.request("/health/reports/generate", {
        method: "POST",
        body: JSON.stringify({
  ...
  const downloadReport = async () => {
    ...
    try {
      // Para download de arquivos binários, usar fetch direto com apiClient baseURL
      const response = await fetch(`${apiClient.baseURL}/health/reports/download`, {
        method: "POST",
