    ...
    <>
      ...
      >
        <div className="relative">
          ...
          {itemCount > 0 && (
            <Badge className="absolute -top-3 -right-3 bg-red-500 text-white border-2 border-white min-w-[24px] h-6 flex items-center justify-center px-1.5 rounded-full text-xs font-bold">
