...
describe("PaymentMethods", () => {
  ...
  it("renders payment methods correctly", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Escolha a forma de pagamento"),
      ).toBeInTheDocument();
  ...
  it("shows correct method names and descriptions", async () => {
    ...
    await waitFor(() => {
      ...
      expect(
        screen.getByText("Vencimento em 3 dias úteis"),
      ).toBeInTheDocument();
    });
  });
  ...
  it("shows security information", async () => {
    ...
    await waitFor(() => {
      ...
      expect(
        screen.getByText("Criptografia SSL de 256 bits"),
      ).toBeInTheDocument();
