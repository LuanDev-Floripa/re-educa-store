...
const ProductCard = ({
  ...
  // Modo grid (padrão)
  return (
    <Card className="group hover:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06),0_0_0_1px_rgba(0,0,0,0.05)] transition-all duration-300 border-0 shadow-[0_1px_2px_0_rgba(0,0,0,0.05),0_1px_3px_0_rgba(0,0,0,0.1)] flex flex-col h-full">
      <div className="relative overflow-hidden rounded-t-2xl">
        <img
          src={product.image}
          alt={product.name}
          className="w-full h-48 object-cover group-hover:scale-[1.02] transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]"
        />
        {product.isNew && (
          <Badge variant="default" className="absolute top-2 left-2">
...
// ProductCard é renderizado múltiplas vezes em listas/grids, otimização importante
