...
const CreatePostModal = ({
  ...
  const moods = [
    { value: "happy", label: "😊 Feliz", color: "text-primary" },
    { value: "excited", label: "🤩 Empolgado", color: "text-primary" },
    { value: "motivated", label: "💪 Motivado", color: "text-primary" },
    { value: "proud", label: "🏆 Orgulhoso", color: "text-primary" },
    { value: "grateful", label: "🙏 Grato", color: "text-primary" },
    { value: "focused", label: "🎯 Focado", color: "text-primary" },
    { value: "relaxed", label: "😌 Relaxado", color: "text-primary" },
    { value: "determined", label: "🔥 Determinado", color: "text-primary" },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Criar post via API usando apiClient
      const response = await apiClient.request("/api/social/posts", {
        method: "POST",
        body: formData,
        includeAuth: true,
      });
      ...
      if (response.success || response.post) {
        ...
        throw new Error(response.error || "Erro ao criar post");
      }
    } catch (error) {
...
// Modal é controlado por estado, mas otimização ajuda quando aberto
