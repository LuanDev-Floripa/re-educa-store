          ...
          <div className="flex space-x-4 overflow-x-auto pb-2">
            ...
            <div className="flex-shrink-0 text-center">
              <div className="relative">
                <Button
                  ...
                  className="w-16 h-16 rounded-full p-0 border-2 border-dashed border-border hover:border-primary"
                >
                  <Plus className="h-6 w-6 text-muted-foreground" />
                </Button>
              </div>
              <p className="text-xs text-muted-foreground mt-1">Criar</p>
            </div>
            ...
            {Object.values(userStories).map((userStory) => (
              ...
              >
                  ...
                  <div
                    className={`w-16 h-16 rounded-full p-0.5 ${
                      userStory.hasUnviewed
                        ? "bg-gradient-to-tr from-primary via-primary to-primary"
                        : "bg-muted"
                    }`}
                  >
                    <Button
                ...
                <p className="text-xs text-foreground mt-1 truncate w-16">
                  {userStory.user.name}
                </p>
              </div>
            ))}
                ...
                >
                  {!isPlaying && (
                    <Button
                      variant="ghost"
                      size="lg"
                      className="text-foreground hover:bg-white/20 rounded-full w-16 h-16"
                    >
...
// StoriesSection pode ter muitos stories, otimização importante
