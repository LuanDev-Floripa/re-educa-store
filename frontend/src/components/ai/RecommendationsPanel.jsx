    ...
    async (type = "all") => {
      ...
      try {
        ...
        if (type === "all" || type === "products") {
          requests.push(
            apiClient.request("/ai/recommendations/products?limit=6")
        ...
        if (type === "all" || type === "exercises") {
          requests.push(
            apiClient.request("/ai/recommendations/exercises?limit=6")
        ...
        if (type === "all" || type === "nutrition") {
          requests.push(
            apiClient.request("/ai/recommendations/nutrition?limit=6")
        ...
        if (type === "all" || type === "trends") {
          requests.push(
            apiClient.request("/ai/predictions/health-trends?days_ahead=30")
        ...
        if (type === "all" || type === "users") {
          requests.push(
            apiClient.request("/ai/similar-users?limit=5")
