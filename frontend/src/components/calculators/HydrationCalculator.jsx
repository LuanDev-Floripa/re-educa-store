/**
 * HydrationCalculator Component - RE-EDUCA Store
 * 
 * Calculadora de hidratação diária recomendada.
 * 
 * Funcionalidades:
 * - Cálculo de necessidade hídrica diária
 * - Considera peso, idade, atividade física
 * - Fatores climáticos
 * - Condições de saúde
 * - Recomendações personalizadas
 * 
 * @component
 * @returns {JSX.Element} Calculadora de hidratação
 */
  ...
  const climates = [
    {
      ...
      label: "Temperado",
      factor: 1.0,
      description: "20-25°C, umidade normal",
    },
    {
      value: "hot",
      label: "Quente",
      factor: 1.3,
      description: "25-30°C, umidade alta",
    },
    {
      value: "very_hot",
      label: "Muito Quente",
      factor: 1.5,
      description: "30°C+, umidade muito alta",
    },
    {
      value: "cold",
      label: "Frio",
      factor: 0.9,
      description: "Abaixo de 15°C",
    },
    {
      value: "dry",
      label: "Seco",
      factor: 1.2,
      description: "Baixa umidade, altitude",
    },
  ];
  ...
  const exerciseIntensities = [
    {
      ...
      label: "Baixa",
      factor: 0.5,
      description: "Caminhada leve, yoga",
    },
    {
      value: "moderate",
      label: "Moderada",
      factor: 1.0,
      description: "Corrida leve, ciclismo",
    },
    {
      value: "high",
      label: "Alta",
      factor: 1.5,
      description: "Corrida intensa, HIIT",
    },
    {
      value: "very_high",
      label: "Muito Alta",
  ...
  const calculateHydration = async () => {
    ...
    try {
      ...
      setResults({
        ...
        otherFluids,
        hourlyIntake,
        preWorkout: exerciseDuration
          ? Math.round(parseFloat(exerciseDuration) * 5)
          : 0,
        duringWorkout: exerciseDuration
          ? Math.round(parseFloat(exerciseDuration) * 10)
          : 0,
        postWorkout: exerciseDuration
          ? Math.round(parseFloat(exerciseDuration) * 15)
          : 0,
        dehydrationSigns,
        benefits,
      ...
      logger.error("Erro ao calcular hidratação:", error);
  ...
  const getHydrationStatus = () => {
    if (!dailyIntake)
      return {
        status: "unknown",
        color: "gray",
        message: "Calcule suas necessidades",
      };
    ...
    if (percentage >= 100) {
      ...
      return {
        status: "poor",
        color: "red",
        message: "Precisa beber mais água",
      };
    }
  };
        ...
        <div className="flex items-center justify-center space-x-3 mb-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Calcule suas necessidades diárias de água e acompanhe sua
              hidratação
            </p>
          </div>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleInputChange("climate", value)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Selecione" />
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleInputChange("exerciseIntensity", value)
                      }
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Selecione" />
                ...
                <div className="space-y-2">
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("medications", e.target.checked)
                      }
                      className="rounded"
                    />
                  ...
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("pregnancy", e.target.checked)
                      }
                      className="rounded"
                    />
                  ...
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("breastfeeding", e.target.checked)
                      }
                      className="rounded"
                    />
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between items-center p-2 bg-muted rounded">
                          <span className="text-sm">
                            Por hora (16h acordado):
                          </span>
                          <span className="font-semibold">
                            {results.hourlyIntake}ml
                          </span>
                        </div>
              ...
              <CardContent>
                {dailyIntake > 0 ? (
                    ...
                    <div className="text-center">
                      <div
                        className={`text-4xl font-bold mb-2 ${
                          hydrationStatus.color === "green"
                            ? "text-primary"
                            : hydrationStatus.color === "blue"
                              ? "text-primary"
                              : hydrationStatus.color === "yellow"
                                ? "text-primary"
                                : "text-destructive"
                        }`}
                      >
                      ...
                      <Progress
                        value={(currentIntake / dailyIntake) * 100}
                        className="h-3 mb-4"
                      />
                      <div className="text-sm text-muted-foreground">
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground">
                      Calcule suas necessidades primeiro para começar o
                      acompanhamento
                    </p>
                  </div>
                )}
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Comece o dia com um copo de água para reidratar após o
                        sono
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Beba água 30 minutos antes das refeições para melhor
                        digestão
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Hidrate-se a cada 15-20 minutos durante atividades
                        físicas
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Urina clara indica boa hidratação, escura indica
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  A água é essencial para o funcionamento de todos os órgãos e
                  sistemas do corpo. Representa cerca de 60% do peso corporal em
                  adultos.
                </p>
                <div className="space-y-2">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>
                      • <strong>Cérebro:</strong> Melhora concentração e memória
                    </li>
                    <li>
                      • <strong>Pele:</strong> Mantém elasticidade e brilho
                    </li>
                    <li>
                      • <strong>Rins:</strong> Previne pedras nos rins
                    </li>
                    <li>
                      • <strong>Digestão:</strong> Ajuda na absorção de
                      nutrientes
                    </li>
                    <li>
                      • <strong>Exercício:</strong> Melhora performance e
                      recuperação
                    </li>
                    <li>
                      • <strong>Peso:</strong> Ajuda no controle do apetite
                    </li>
                  </ul>
                </div>
              </CardContent>
