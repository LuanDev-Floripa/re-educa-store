...
export const GoalsSystem = ({ 
  ...
  const defaultGoals = useMemo(() => [
    {
      ...
      bgColor: 'bg-green-50',
      milestones: [
        { id: 1, name: 'Primeiro kg', target: 74, achieved: true, achievedAt: '2024-01-15' },
        { id: 2, name: 'Metade do caminho', target: 72.5, achieved: false, achievedAt: null },
        { id: 3, name: 'Meta final', target: 70, achieved: false, achievedAt: null }
      ],
      reminders: [
        { id: 1, type: 'weekly', message: 'Verificar progresso semanal', enabled: true },
        { id: 2, type: 'monthly', message: 'Avaliar metas mensais', enabled: true }
      ],
    ...
    },
    {
      ...
      bgColor: 'bg-blue-50',
      milestones: [
        { id: 1, name: 'Primeiro kg', target: 66, achieved: false, achievedAt: null },
        { id: 2, name: 'Metade do caminho', target: 67.5, achieved: false, achievedAt: null },
        { id: 3, name: 'Meta final', target: 70, achieved: false, achievedAt: null }
      ],
      reminders: [
        { id: 1, type: 'weekly', message: 'Verificar progresso semanal', enabled: true },
    ...
    },
    {
      ...
      milestones: [
        { id: 1, name: 'Primeira redução', target: 14, achieved: true, achievedAt: '2024-01-20' },
        { id: 2, name: 'Metade do caminho', target: 13.5, achieved: false, achievedAt: null },
        { id: 3, name: 'Meta final', target: 12, achieved: false, achievedAt: null }
      ],
      reminders: [
        { id: 1, type: 'weekly', message: 'Verificar progresso semanal', enabled: true },
        { id: 2, type: 'monthly', message: 'Avaliar metas mensais', enabled: true }
    ...
    },
    {
      ...
      milestones: [
        { id: 1, name: '25 treinos', target: 25, achieved: true, achievedAt: '2024-01-15' },
        { id: 2, name: '50 treinos', target: 50, achieved: false, achievedAt: null },
        { id: 3, name: '75 treinos', target: 75, achieved: false, achievedAt: null },
        { id: 4, name: '100 treinos', target: 100, achieved: false, achievedAt: null }
      ],
      reminders: [
        { id: 1, type: 'weekly', message: 'Verificar progresso semanal', enabled: true },
        { id: 2, type: 'monthly', message: 'Avaliar metas mensais', enabled: true }
    ...
    },
    {
      ...
      bgColor: 'bg-red-50',
      milestones: [
        { id: 1, name: '30 minutos', target: 30, achieved: true, achievedAt: '2024-01-10' },
        { id: 2, name: '27 minutos', target: 27, achieved: false, achievedAt: null },
        { id: 3, name: '25 minutos', target: 25, achieved: false, achievedAt: null }
      ],
      reminders: [
        { id: 1, type: 'weekly', message: 'Verificar progresso semanal', enabled: true },
        { id: 2, type: 'monthly', message: 'Avaliar metas mensais', enabled: true }
    ...
    },
    {
      ...
      bgColor: 'bg-cyan-50',
      milestones: [
        { id: 1, name: 'Meta alcançada', target: 1, achieved: true, achievedAt: '2024-01-25' }
      ],
      reminders: [],
      createdAt: '2024-01-01T00:00:00Z',
  ...
  const goalCategories = [
    ...
    { id: 'muscle', name: 'Massa Muscular', icon: TrendingUp, color: 'text-blue-600' },
    { id: 'body_fat', name: 'Gordura Corporal', icon: Target, color: 'text-purple-600' },
    { id: 'workout', name: 'Treinos', icon: Activity, color: 'text-orange-600' },
    { id: 'running', name: 'Corrida', icon: Zap, color: 'text-red-600' },
    { id: 'flexibility', name: 'Flexibilidade', icon: Wind, color: 'text-cyan-600' },
    { id: 'strength', name: 'Força', icon: Dumbbell, color: 'text-gray-600' },
    { id: 'endurance', name: 'Resistência', icon: Heart, color: 'text-pink-600' },
    { id: 'nutrition', name: 'Nutrição', icon: Apple, color: 'text-yellow-600' },
    { id: 'sleep', name: 'Sono', icon: Moon, color: 'text-indigo-600' }
  ];

  const goalTypes = [
    { id: 'increase', name: 'Aumentar', icon: TrendingUp, color: 'text-green-600' },
    { id: 'decrease', name: 'Diminuir', icon: TrendingDown, color: 'text-red-600' },
  ...
  const renderGoalCard = (goal) => {
    ...
    const progressPercentage = getProgressPercentage(goal.current, goal.target, goal.type);
        ...
        <CardHeader className="pb-3">
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-3">
              <div className={`p-2 ${getGoalBgColor(goal.category)} rounded-lg`}>
                <IconComponent className={`w-6 h-6 ${getGoalColor(goal.category)}`} />
              </div>
              <div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <div className={`font-medium ${daysRemaining < 0 ? 'text-red-600' : daysRemaining < 7 ? 'text-yellow-600' : 'text-green-600'}`}>
  ...
  const tabs = [
    { id: 'active', label: 'Ativas', count: goals.filter(g => g.status === 'active').length },
    { id: 'completed', label: 'Concluídas', count: goals.filter(g => g.status === 'completed').length },
    { id: 'paused', label: 'Pausadas', count: goals.filter(g => g.status === 'paused').length },
    { id: 'archived', label: 'Arquivadas', count: goals.filter(g => g.status === 'archived').length },
