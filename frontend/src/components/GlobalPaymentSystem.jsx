...
const GlobalPaymentSystem = () => {
  ...
  // Carregar produtos reais da API usando apiService
  ...
  if (errorMsg) {
    return (
      <div className="min-h-screen flex items-center justify-center text-destructive text-xl">{errorMsg}</div>
    );
  }
...
const ProductSelection = ({ 
  ...
  const applyDiscount = async () => {
    ...
    try {
      ...
      logger.error('Erro ao validar desconto:', error);
  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-muted-foreground">Selecione o plano ideal para suas necessidades de saúde e bem-estar</p>
      </div>
