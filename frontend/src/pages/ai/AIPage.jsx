    ...
    <div className="container mx-auto px-4 py-8 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          ...
          Receba recomendações inteligentes, converse com nosso assistente e analise imagens.
        </p>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Precisão nas Recomendações</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-primary mb-2">10k+</div>
              <p className="text-sm text-muted-foreground">Análises de Imagem Realizadas</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-primary mb-2">24/7</div>
              <p className="text-sm text-muted-foreground">Assistente Disponível</p>
            </div>
          </div>
        </CardContent>
      </Card>
