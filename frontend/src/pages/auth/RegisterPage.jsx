...
import { Heart, Eye, EyeOff, User, Mail, Lock, ArrowRight, CheckCircle, AlertCircle } from 'lucide-react';
...
export const RegisterPage = () => {
    ...
    try {
      ...
      if (result.success && result.user) {
        toast.success('Conta criada com sucesso!', {
          description: `Bem-vindo ao RE-EDUCA, ${result.user.name || result.user.email}!`,
        });
  ...
  const getPasswordRequirements = () => {
    ...
    const requirements = [
      { key: 'length', label: 'Mínimo 8 caracteres', met: passwordStrength.checks.length },
      { key: 'uppercase', label: 'Uma letra maiúscula', met: passwordStrength.checks.uppercase },
      { key: 'lowercase', label: 'Uma letra minúscula', met: passwordStrength.checks.lowercase },
      { key: 'number', label: 'Um número', met: passwordStrength.checks.number },
      { key: 'special', label: 'Um caractere especial', met: passwordStrength.checks.special },
    ];
