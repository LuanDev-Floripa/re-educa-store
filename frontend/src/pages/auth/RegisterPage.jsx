...
export const RegisterPage = () => {
  ...
  const getPasswordStrengthColor = (strength) => {
    ...
    if (strength.isValid) return "text-primary";
    if (strength.score >= 3) return "text-primary";
          ...
          >
            ...
            <div className="space-y-2.5">
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground/80" />
                <Input
                  id="name"
                  type="text"
                  placeholder="Seu nome completo"
                  className={`pl-10 ${errors.name ? "border-destructive focus:ring-destructive" : ""}`}
                  {...register("name")}
                  disabled={isLoading}
                  autoComplete="name"
                />
            ...
            <div className="space-y-2.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 pr-10 ${errors.password_confirmation ? "border-destructive focus:ring-destructive" : ""}`}
            ...
            <div className="flex items-start gap-2.5">
              <input
                type="checkbox"
                id="terms"
                className="mt-1 rounded border-border/50 text-primary focus:ring-primary focus:ring-offset-0 transition-all duration-200"
                required
                disabled={isLoading}
              />
              <label
