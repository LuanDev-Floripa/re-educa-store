  ...
  const workoutPlansDataFallback = [
    {
      ...
      description:
        "Plano completo para quem está começando na academia. Foco em aprender os movimentos básicos e criar uma base sólida.",
      category: "Iniciante",
      difficulty: "beginner",
      duration: 8,
      workouts_per_week: 3,
    ...
    },
    {
      ...
      description:
        "Treino de alta intensidade para queimar gordura rapidamente. Perfeito para quem tem pouco tempo mas quer resultados.",
      category: "Cardio",
    ...
    },
    {
      ...
      description:
        "Plano intensivo para atletas experientes que buscam ganho de massa muscular significativo.",
      category: "Força",
      difficulty: "advanced",
      duration: 12,
      workouts_per_week: 5,
    ...
    },
    {
      ...
      description:
        "Movimentos funcionais que melhoram a força, equilíbrio e coordenação para atividades do dia a dia.",
      category: "Funcional",
      difficulty: "beginner",
      duration: 6,
      workouts_per_week: 3,
    ...
    },
    {
      ...
      description:
        "Foco em melhorar a capacidade cardiovascular e resistência através de exercícios de longa duração.",
      category: "Cardio",
      difficulty: "intermediate",
      duration: 8,
      workouts_per_week: 4,
    ...
    },
    {
      ...
      name: "Força Máxima",
      description:
        "Plano focado em desenvolver força máxima através de exercícios compostos pesados.",
      category: "Força",
      difficulty: "advanced",
      duration: 10,
      workouts_per_week: 4,
