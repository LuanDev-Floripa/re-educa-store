        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <span className="font-medium text-gray-900 dark:text-white">Catálogo</span>
            ...
            >
              ...
              <span className="font-medium text-gray-900 dark:text-white">Calculadoras</span>
              <span className="text-sm text-gray-500 dark:text-gray-400 text-center">
            ...
            >
              ...
              <span className="font-medium text-gray-900 dark:text-white">Suporte</span>
              <span className="text-sm text-gray-500 dark:text-gray-400 text-center">
                Precisa de ajuda?
              </span>
            </Link>
