...
class SubscriptionService(BaseService):
    ...
    def get_user_subscriptions(self, user_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao buscar assinaturas: {str(e)}")
            return []
    ...
    def get_subscription(self, subscription_id: str, user_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao buscar assinatura: {str(e)}")
            return None

    def update_subscription_by_stripe_id(self,
        stripe_subscription_id: str, update_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            self.logger.error(f"Erro ao atualizar assinatura por Stripe ID: {str(e)}")
            return {'success': False, 'error': 'Erro interno do servidor'}

    def update_subscription_status(self,
        stripe_subscription_id: str, status: str, additional_data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
    ...
    def cancel_subscription(self,
        subscription_id: str, user_id: str, stripe_subscription_id: Optional[str] = None) -> Dict[str, Any]:
        """
