...
class CacheService:
    ...
    def _init_redis(self):
        """
        Inicializa conexão com Redis usando variáveis de ambiente.

        Suporta REDIS_URL ou REDIS_HOST/REDIS_PORT/REDIS_PASSWORD.
        """
        import os

        try:
            # Tentar usar REDIS_URL primeiro (padrão para produção)
    ...
    def get(self, key: str) -> Optional[Any]:
        ...
        try:
            ...
            # Log apenas em debug para evitar poluição de logs
            logger.debug(f"Erro ao obter do cache: {e}")
            return None
    ...
    def set(self, key: str, value: Any, ttl: int = 3600) -> bool:
        ...
        try:
            ...
            logger.debug(f"Erro ao definir no cache: {e}")
            return False
    ...
    def delete(self, key: str) -> bool:
        ...
        try:
            ...
            logger.debug(f"Erro ao deletar do cache: {e}")
            return False
    ...
    def delete_pattern(self, pattern: str) -> int:
        ...
        try:
            ...
            logger.debug(f"Erro ao deletar padrão do cache: {e}")
            return 0
    ...
    def increment(self, key: str, amount: int = 1) -> Optional[int]:
        ...
        try:
            ...
            logger.debug(f"Erro ao incrementar no cache: {e}")
            return None
    ...
    def decrement(self, key: str, amount: int = 1) -> Optional[int]:
        ...
        try:
            ...
            logger.debug(f"Erro ao decrementar no cache: {e}")
            return None
    ...
    def get_ttl(self, key: str) -> int:
        ...
        try:
            ...
            logger.debug(f"Erro ao obter TTL do cache: {e}")
            return -1
    ...
    def set_ttl(self, key: str, ttl: int) -> bool:
        ...
        try:
            ...
            logger.debug(f"Erro ao definir TTL no cache: {e}")
            return False
