...
class UserDashboardService:
    ...
    def get_dashboard_data(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                'workout_summary': self._get_workout_summary(user_id),
                'nutrition_summary': self._get_nutrition_summary(user_id)
            }
        except Exception as e:
            logger.error(f"Erro ao buscar dashboard do usuário {user_id}: {str(e)}")
    ...
    def _calculate_health_score(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'category': category,
                'color': color,
                'trend': 'up' if score >= 50 else 'stable'
            }
        except Exception as e:
    ...
    def _get_weekly_goals(self, user_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Erro ao buscar metas semanais: {str(e)}")
            return self._get_default_goals()
    ...
    def _get_quick_stats(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Erro ao buscar quick stats: {str(e)}")
            return {
                'total_orders': 0,
                'total_favorites': 0,
                'total_reviews': 0,
    ...
    def _get_workout_summary(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Erro ao buscar resumo de treinos: {str(e)}")
            return {
                'total_workouts': 0,
                'total_minutes': 0,
                'total_calories': 0,
    ...
    def _get_nutrition_summary(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Erro ao buscar resumo nutricional: {str(e)}")
            return {
                'calories': 0,
                'protein': 0,
                'carbs': 0,
    ...
    def _calculate_streak(self, user_id: str) -> int:
        ...
        try:
            ...
            logger.error(f"Erro ao calcular streak: {str(e)}")
            return 0
    ...
    def _get_empty_dashboard(self) -> Dict[str, Any]:
        ...
        return {
            'health_score': {'score': 0, 'category': 'Iniciante', 'color': 'gray', 'trend': 'stable'},
            'weekly_goals': self._get_default_goals(),
            'recent_activities': [],
            'achievements': [],
            'quick_stats': {
                'total_orders': 0,
