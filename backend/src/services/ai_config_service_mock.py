...
class AIConfigServiceMock:
    ...
    def get_ai_config(self, provider: str, service_name: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao obter configuração mock de IA: {str(e)}")
    ...
    def list_ai_configs(self, include_inactive: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao listar configurações mock de IA: {str(e)}")
            return {'success': False, 'error': 'Erro interno do servidor'}
    ...
    def test_ai_config(self, config_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao testar configuração mock de IA: {str(e)}")
            return {'success': False, 'error': 'Erro interno do servidor'}
    ...
    def log_ai_usage(self, config_id: str, user_id: str, request_type: str, 
        ...
        try:
            ...
            self.logger.error(f"Erro ao registrar uso mock de IA: {str(e)}")
            return {'success': False, 'error': 'Erro interno do servidor'}
