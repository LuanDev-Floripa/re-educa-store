...
from services.monitoring_service import monitor_performance, monitoring_service
...
class IntegrationService:
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        """
        health_status = {"overall": "healthy", "services": {}, "timestamp": monitoring_service.start_time.isoformat()}
        ...
        try:
            ...
            health_status["services"]["monitoring"] = {"status": "error", "error": str(e)}
        ...
        try:
            ...
            health_status["services"]["video_upload"] = {"status": "error", "error": str(e)}

        # Verificar Live Streaming
        try:
            # Verificar se o serviço está inicializado
            health_status["services"]["live_streaming"] = {"status": "healthy", "initialized": True}
        except (ValueError, KeyError) as e:
            logger.warning(f"Erro de validação: {str(e)}")
            # Tratamento específico pode ser adicionado aqui
        except Exception as e:
            health_status["services"]["live_streaming"] = {"status": "error", "error": str(e)}
