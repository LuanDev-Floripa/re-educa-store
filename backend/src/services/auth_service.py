...
from config.security import hash_password, verify_password, generate_token
...
class AuthService:
    ...
    def __init__(self):
        ...
        # ✅ CORRIGIDO: Usa UserRepository em vez de supabase direto
    ...
    def register_user(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        try:
            # ✅ CORRIGIDO: Verifica se email já existe via repositório
            ...
            # ✅ CORRIGIDO: Usa UserRepository para criar
    ...
    def authenticate_user(self, email: str, password: str) -> Dict[str, Any]:
        ...
        """
        try:
            # ✅ CORRIGIDO: Busca usuário por email via repositório
    ...
    def change_password(self, user_id: str, current_password: str, new_password: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # ✅ CORRIGIDO: Atualiza senha via repositório
