...
class AIKeyRotationService:
    ...
    def check_key_rotation_needed(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # ✅ CORRIGIDO: Buscar configurações via repositório
    ...
    def rotate_key(self, config_id: str, new_api_key: str, rotated_by: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # ✅ CORRIGIDO: Salvar backup via repositório
            self.rotation_repo.create_rotation_log(backup_data)

            # ✅ CORRIGIDO: Atualizar configuração via repositório
            update_data = {
    ...
    def auto_rotate_keys(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for config in rotation_check['configs_to_rotate']:
                try:
                    ...
                    if self._is_mock_mode():
                        ...
                        self.logger.warning(
                            f"Rotacao automatica necessaria para {config['id']} - "
                            f"implementar logica de producao"
                        )
            ...
            return {
                'success': True,
                'message': (
                    f'Rotacao automatica concluida: {len(rotated_configs)} sucessos, '
                    f'{len(failed_configs)} falhas'
                ),
    ...
    def get_rotation_history(self, config_id: str = None, limit: int = 50) -> Dict[str, Any]:
        ...
        try:
            # ✅ CORRIGIDO: Usa AIKeyRotationRepository
