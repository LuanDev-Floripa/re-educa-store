...
def sample_user_data():
    ...
    return {"id": "test-user-id", "email": "test@example.com", "name": "Test User", "subscription_plan": "free"}
...
def sample_stripe_customer():
    ...
    return {
        ...
        "name": "Test User",
        "metadata": {"user_id": "test-user-id", "subscription_plan": "free"},
    }
...
class TestPaymentService:
    ...
    def test_create_stripe_customer_success(
        self, payment_service, mock_stripe, sample_user_data, sample_stripe_customer
    ):
    ...
    def test_create_stripe_payment_intent_success(self, payment_service, mock_stripe, sample_payment_intent):
        ...
        result = payment_service.create_stripe_payment_intent(
            amount=100.0, currency="brl", customer_id="cus_test123", metadata={"order_id": "order-123"}
        )
    ...
    def test_create_stripe_subscription_success(self, payment_service, mock_stripe):
        ...
        result = payment_service.create_stripe_subscription(customer_id="cus_test123", price_id="price_test123")
    ...
    def test_handle_stripe_webhook_payment_success(self, payment_service, mock_supabase):
        ...
        with patch("src.services.payment_service.stripe.Webhook.construct_event") as mock_webhook:
            mock_webhook.return_value = {
                ...
                "data": {"object": {"id": "pi_test123", "metadata": {"order_id": "order-123"}}},
            }
    ...
    def test_create_pagseguro_payment_success(self, payment_service, mock_requests):
        ...
        order_data = {
            "order_id": "order-123",
            "items": [{"id": "item-1", "name": "Produto Teste", "price": 50.0, "quantity": 1}],
    ...
    def test_create_pagseguro_payment_error(self, payment_service, mock_requests):
        ...
        order_data = {
            "order_id": "order-123",
            "items": [],
            "customer": {"name": "Test User", "email": "invalid-email", "phone": "11999999999"},
        }
...
class TestPaymentRoutes:
    ...
    def test_create_stripe_payment_intent_route_success(
        self, client, mock_stripe, sample_stripe_customer, sample_payment_intent
    ):
        ...
        with patch("src.routes.payments.token_required") as mock_decorator:
            ...
            with patch("src.routes.payments.request") as mock_request:
                ...
                data = {"amount": 100.0, "currency": "brl"}

                response = client.post(
                    "/api/payments/stripe/create-payment-intent", data=json.dumps(data), content_type="application/json"
                )
    ...
    def test_create_stripe_subscription_route_success(self, client, mock_stripe, sample_stripe_customer):
        ...
        with patch("src.routes.payments.token_required") as mock_decorator:
            ...
            with patch("src.routes.payments.request") as mock_request:
                ...
                data = {"price_id": "price_test123"}

                response = client.post(
                    "/api/payments/stripe/create-subscription", data=json.dumps(data), content_type="application/json"
                )
    ...
    def test_stripe_webhook_route_success(self, client, mock_stripe):
        ...
        with patch("src.services.payment_service.stripe.Webhook.construct_event") as mock_webhook:
            ...
            with patch.object(PaymentService, "_update_payment_status") as mock_update:
                ...
                response = client.post("/api/payments/stripe/webhook", headers={"Stripe-Signature": "test_signature"})
    ...
    def test_cancel_subscription_route_success(self, client, mock_supabase, mock_stripe):
        ...
        mock_supabase.table.return_value.select.return_value.eq.return_value.eq.return_value.execute.return_value.data = [
            {"id": "sub-123", "stripe_subscription_id": "sub_stripe123"}
        ]
        mock_supabase.table.return_value.update.return_value.eq.return_value.execute.return_value = None
