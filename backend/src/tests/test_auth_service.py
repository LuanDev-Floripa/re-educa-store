...
class TestAuthService:
    ...
    def test_register_user_success(self, auth_service, mock_supabase_client):
        ...
        # Arrange
        user_data = {"email": "newuser@example.com", "password": "SecurePass123!", "name": "New User"}
    ...
    def test_register_user_email_exists(self, auth_service, mock_supabase_client):
        ...
        # Arrange
        user_data = {"email": "existing@example.com", "password": "SecurePass123!", "name": "Existing User"}
    ...
    def test_update_user_profile_success(self, auth_service, mock_supabase_client):
        ...
        # Arrange
        user_id = "user-123"
        profile_data = {"name": "Updated Name", "phone": "11999999999"}
        mock_supabase_client.update_user.return_value = {"id": user_id, **profile_data}
