...
class TestAuthService:
    ...
    def test_register_user_email_exists(self, auth_service, mock_supabase):
        ...
        # Dados de teste
        user_data = {"name": "Test User", "email": "existing@example.com", "password": "password123"}
    ...
    def test_verify_email_success(self, auth_service, mock_supabase):
        ...
        with patch("src.services.auth_service.verify_token") as mock_verify:
            ...
            mock_supabase.table.return_value.select.return_value.eq.return_value.eq.return_value.execute.return_value.data = [
                {"token": "test-token", "expires_at": "2025-12-31T23:59:59Z"}
            ]
            mock_supabase.table.return_value.select.return_value.eq.return_value.execute.return_value.data = [
...
class TestAuthRoutes:
    ...
    def test_verify_email_route_success(self, client, mock_supabase):
        ...
        with patch("src.routes.auth.verify_token") as mock_verify:
            ...
            with patch("src.routes.auth.EmailService") as mock_email_service:
                ...
                # Executa teste
                response = client.post("/api/auth/verify-email", data=json.dumps(data), content_type="application/json")
    ...
    def test_forgot_password_route_success(self, client, mock_supabase):
        ...
        with patch("src.routes.auth.EmailService") as mock_email_service:
            ...
            # Executa teste
            response = client.post("/api/auth/forgot-password", data=json.dumps(data), content_type="application/json")
...
class TestEmailService:
    ...
    def test_send_verification_email(self):
        ...
        with patch("src.services.email_service.smtplib.SMTP") as mock_smtp:
            ...
            # Executa teste
            result = email_service.send_verification_email("test@example.com", "Test User", "verification-token")
    ...
    def test_send_password_reset_email(self):
        ...
        with patch("src.services.email_service.smtplib.SMTP") as mock_smtp:
            ...
            # Executa teste
            result = email_service.send_password_reset_email("test@example.com", "Test User", "reset-token")
