...
class TestNutritionSystem:
    ...
    @patch('main.jwt.decode')
    @patch('main.requests.get')
    def test_search_foods_multiple_results(self, mock_requests_get, mock_jwt_decode, mock_supabase, client, auth_headers):
    ...
    @patch('main.jwt.decode')
    @patch('main.requests.get')
    def test_search_foods_query_parameters(self, mock_requests_get, mock_jwt_decode, mock_supabase, client, auth_headers):
    ...
    @patch('main.jwt.decode')
    @patch('main.requests.get')
    def test_search_foods_special_characters(self, mock_requests_get, mock_jwt_decode, mock_supabase, client, auth_headers):
