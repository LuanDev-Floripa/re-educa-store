...
class WorkoutPlanRepository(BaseRepository):
    ...
    def create_plan(self, plan_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao criar plano de treino: {str(e)}")
            return None
    ...
    def update_plan(self, plan_id: str, plan_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao atualizar plano de treino: {str(e)}")
            return None
    ...
    def delete_plan(self, plan_id: str) -> bool:
        ...
        try:
            ...
            self.logger.error(f"Erro ao deletar plano de treino: {str(e)}")
            return False
    ...
    def add_exercise_to_plan(
        ...
        try:
            ...
            result = (
                self.db.table('workout_plan_exercises')
            ...
            self.logger.error(f"Erro ao adicionar exercício ao plano: {str(e)}")
            return None
    ...
    def get_plan_exercises(
        ...
        try:
            ...
            self.logger.error(f"Erro ao buscar exercícios do plano: {str(e)}")
            return []
    ...
    def delete_plan_exercises(self, plan_id: str) -> bool:
        ...
        try:
            ...
            self.logger.error(f"Erro ao deletar exercícios do plano: {str(e)}")
            return False
    ...
    def find_by_user(self, user_id: str, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao buscar planos do usuário: {str(e)}")
            return []
