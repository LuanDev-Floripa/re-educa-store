...
class VideoRepository(BaseRepository):
    ...
    def create_video(self, video_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao criar vídeo: {str(e)}")
            return None
    ...
    def find_by_user(
        ...
        try:
            ...
            self.logger.error(f"Erro ao buscar vídeos do usuário: {str(e)}")
            return []
    ...
    def update_video_status(
        ...
        try:
            ...
            self.logger.error(f"Erro ao atualizar status do vídeo: {str(e)}")
            return None
    ...
    def delete_video(self, video_id: str, user_id: str) -> bool:
        ...
        try:
            ...
            self.logger.error(f"Erro ao deletar vídeo: {str(e)}")
            return False
