...
class CouponUsageRepository(BaseRepository):
    ...
    def count_by_coupon(self, coupon_id: str) -> int:
        ...
        try:
            ...
            self.logger.error(f"Erro ao contar usos do cupom: {str(e)}")
            return 0
    ...
    def count_by_coupon_and_user(self, coupon_id: str, user_id: str) -> int:
        ...
        try:
            ...
            self.logger.error(f"Erro ao contar usos do cupom por usuário: {str(e)}")
            return 0
    ...
    def get_total_discount_by_coupon(self, coupon_id: str) -> float:
        ...
        try:
            ...
            self.logger.error(f"Erro ao calcular desconto total: {str(e)}")
            return 0.0
    ...
    def get_unique_users_by_coupon(self, coupon_id: str) -> int:
        ...
        try:
            ...
            self.logger.error(f"Erro ao contar usuários únicos: {str(e)}")
            return 0
    ...
    def record_usage(
        ...
        try:
            ...
            self.logger.error(f"Erro ao registrar uso do cupom: {str(e)}")
            return None
    ...
    def get_coupon_stats(self, coupon_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao obter estatísticas do cupom: {str(e)}")
            return {
                'total_usage': 0,
                'total_discount': 0.0,
                'unique_users': 0
