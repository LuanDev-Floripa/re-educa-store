...
class HealthRepository(BaseRepository):
    ...
    def create_biological_age_calculation(self, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao criar cálculo de idade biológica: {str(e)}")
            return None
    ...
    def create_hydration_calculation(self, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao criar cálculo de hidratação: {str(e)}")
            return None
    ...
    def create_metabolism_calculation(self, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao criar cálculo de metabolismo: {str(e)}")
            return None
    ...
    def create_sleep_calculation(self, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao criar cálculo de sono: {str(e)}")
            return None
    ...
    def create_stress_calculation(self, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao criar cálculo de estresse: {str(e)}")
            return None
    ...
    def find_by_user_and_type(
        ...
        try:
            ...
            self.logger.error(f"Erro ao buscar cálculos: {str(e)}")
            return []
    ...
    def create_health_calculation(self, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao criar cálculo de saúde: {str(e)}")
            return None
    ...
    def save_imc_calculation(self, user_id: str, calculation_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        return self.create_imc_history({
            'user_id': user_id,
            **calculation_data
        })
    ...
    def save_calorie_calculation(self, user_id: str, calculation_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        return self.create_calories_history({
            'user_id': user_id,
            **calculation_data
        })
    
    def save_calculation(self, calculation_type: str, user_id: str, entry_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            ...
            self.logger.error(f"Erro ao salvar cálculo {calculation_type}: {str(e)}")
            return None
    ...
    def get_calculation_history(
        ...
        try:
            ...
            self.logger.error(f"Erro ao buscar histórico de {calculation_type}: {str(e)}")
            return {
                'entries': [],
                'pagination': {
                    'page': page,
    ...
    def get_imc_history(self, user_id: str, page: int = 1, per_page: int = 20) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Erro ao buscar histórico de IMC: {str(e)}")
            return {
                'entries': [],
                'pagination': {
                    'page': page,
    ...
    def get_biological_age_history(
        ...
        try:
            ...
            query = (
                self.db.table('biological_age_calculations')
                .select('*')
                .eq('user_id', user_id)
            )
    ...
    def get_hydration_history(
        ...
        try:
            ...
            query = (
                self.db.table('hydration_calculations')
                .select('*')
                .eq('user_id', user_id)
            )
    ...
    def get_exercise_entries(
        ...
        try:
            ...
            query = (
                self.db.table('exercise_entries')
                .select('*')
                .eq('user_id', user_id)
            )
            ...
            self.logger.error(f"Erro ao buscar entradas de exercícios: {str(e)}")
            return []
