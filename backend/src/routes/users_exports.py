...
def get_export_history():
    ...
    Implementa tratamento robusto de exceções e utiliza LGPDService.
    ...
    # Utiliza LGPDService para busca padronizada
    try:
        ...
        exports_list = []  # Continua mesmo se houver erro
...
def get_scheduled_exports():
    ...
    Implementa tratamento robusto de exceções e busca de exportações agendadas.
    ...
    # NOTA: Ainda usa acesso direto ao Supabase - pode ser melhorado depois
    try:
        ...
        scheduled_list = []  # Continua mesmo se houver erro
...
def create_export():
    ...
    Implementa tratamento robusto de exceções e criação de exportações.
    ...
    try:
        ...
        # Utiliza LGPDService para criação padronizada
        ...
        # Retorna sucesso com ID temporário para manter compatibilidade com frontend
        return jsonify({
            'success': True,
            'export_id': str(uuid.uuid4()),
