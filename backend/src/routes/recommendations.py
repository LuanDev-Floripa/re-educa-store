...
def get_personalized_recommendations():
    ...
    try:
        ...
        # OTIMIZADO: Recomendações de produtos com IA preditiva
        if rec_type in ['all', 'products']:
            try:
                # Usa serviço de produtos (já otimizado com cache)
        ...
        # OTIMIZADO: Inclui análise preditiva se disponível
        analysis_info = {}
        try:
            # Usa IA para análise preditiva de tendências (opcional)
