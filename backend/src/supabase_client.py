...
class SupabaseClient:
    ...
    def __init__(self):
        ...
        self.anon_key = os.environ.get(
            'SUPABASE_ANON_KEY',
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhnZnJudGJ0cXNhcmVuY3F6c2xhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzI0NzQ4NzMsImV4cCI6MjA0ODA1MDg3M30.8b8b8b8b8b8b8b8b8b8b8b8b8b8b8b8b8b8b8b8b'
        )
        self.headers = {
